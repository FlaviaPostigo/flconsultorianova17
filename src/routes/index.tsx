...
import logoHorizontal from "@/assets/logo-fl-horizontal.png";
  ...
  return (
    <SiteLayout>
      ...
      <section className="hero-clean-surface relative overflow-hidden texture-paper">
        <DiagonalStripes className="pointer-events-none absolute bottom-8 right-8 h-20 w-20 opacity-55" />

        <div className="container-fl relative grid min-h-[calc(100svh-5rem)] items-center gap-8 py-8 md:py-10 lg:grid-cols-[minmax(0,1.35fr)_minmax(290px,0.65fr)] lg:gap-10">
          <div className="min-w-0">
            <div className="rounded-[1.6rem] border border-border/85 bg-cream/88 p-6 shadow-[0_16px_40px_rgba(38,36,91,0.08)] backdrop-blur-sm sm:p-7 lg:p-8">
              <p className="eyebrow">FL Consultoria</p>
              <h1 className="mt-4 max-w-[760px] font-display text-4xl font-semibold leading-[0.98] tracking-tight text-navy sm:text-5xl xl:text-[3.5rem]">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="#eixos"
                  className="inline-flex items-center gap-2 rounded-full bg-mint-deep px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-mint hover:shadow-md"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-navy/20 bg-cream/65 px-5 py-2.5 text-sm font-semibold text-navy transition-all hover:border-navy/40 hover:bg-cream"
                >
          ...
          <div className="relative flex min-w-0 items-center justify-center">
            <div
              className="relative aspect-[5/3] w-full max-w-[440px]"
              aria-label="Elemento gráfico com a identidade da FL Consultoria"
            >
              <svg
                aria-hidden
                viewBox="0 0 600 360"
              ...
              >
                ...
                <ellipse
                  ...
                  ry="112"
                  fill="none"
                  stroke="rgb(118 199 146 / .20)"
                  strokeWidth="2"
                />
                <path
                  d="M58 218 A244 148 0 0 1 330 38"
                  fill="none"
                  stroke="#58B978"
                  strokeWidth="18"
                  strokeLinecap="round"
                />
                <circle cx="494" cy="83" r="12" fill="#76C792" />
                <circle cx="536" cy="146" r="7" fill="#58B978" />
                <circle cx="92" cy="297" r="7" fill="#58B978" />
              </svg>

              <div className="absolute inset-x-[10%] inset-y-[27%] grid place-items-center rounded-[1.45rem] border border-mint-deep/35 bg-cream/95 px-7 py-5 shadow-[0_14px_34px_rgba(38,36,91,0.13)] backdrop-blur-sm">
                <img
                  src={logoHorizontal}
                  alt="FL Consultoria — Soluções em Educação Corporativa e Desenvolvimento Organizacional"
